...
/// so marketing assets (README, Play Store listing, official website) can
/// be generated without manually navigating the app.
///
/// Run with:
///   fvm flutter drive \
...
void main() {
  ...
  testWidgets('capture marketing screenshots', (tester) async {
    ...
    /// looping or position-based animations that never let `pumpAndSettle`
    /// return, so screens are advanced with a fixed number of pumps
    /// instead.
