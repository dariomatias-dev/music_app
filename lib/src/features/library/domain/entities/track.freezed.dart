...
mixin _$Track {
 ...
 String get id; String get sourceId; String get filePath; String get title; String get artistId; String get albumId; Duration get duration; String get format; int get fileSize; bool get hasEmbeddedArtwork; DateTime get dateAdded; DateTime get dateModified; int? get trackNumber; int? get discNumber; int? get year; String? get genre; int? get bitrate; int? get sampleRate;
...
@override
int get hashCode => Object.hash(runtimeType,id,sourceId,filePath,title,artistId,albumId,duration,format,fileSize,hasEmbeddedArtwork,dateAdded,dateModified,trackNumber,discNumber,year,genre,bitrate,sampleRate);

@override
String toString() {
  return 'Track(id: $id, sourceId: $sourceId, filePath: $filePath, title: $title, artistId: $artistId, albumId: $albumId, duration: $duration, format: $format, fileSize: $fileSize, hasEmbeddedArtwork: $hasEmbeddedArtwork, dateAdded: $dateAdded, dateModified: $dateModified, trackNumber: $trackNumber, discNumber: $discNumber, year: $year, genre: $genre, bitrate: $bitrate, sampleRate: $sampleRate)';
}
...
@useResult
$Res call({
 String id, String sourceId, String filePath, String title, String artistId, String albumId, Duration duration, String format, int fileSize, bool hasEmbeddedArtwork, DateTime dateAdded, DateTime dateModified, int? trackNumber, int? discNumber, int? year, String? genre, int? bitrate, int? sampleRate
});
...
as DateTime,trackNumber: freezed == trackNumber ? _self.trackNumber : trackNumber // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String sourceId,  String filePath,  String title,  String artistId,  String albumId,  Duration duration,  String format,  int fileSize,  bool hasEmbeddedArtwork,  DateTime dateAdded,  DateTime dateModified,  int? trackNumber,  int? discNumber,  int? year,  String? genre,  int? bitrate,  int? sampleRate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Track() when $default != null:
return $default(_that.id,_that.sourceId,_that.filePath,_that.title,_that.artistId,_that.albumId,_that.duration,_that.format,_that.fileSize,_that.hasEmbeddedArtwork,_that.dateAdded,_that.dateModified,_that.trackNumber,_that.discNumber,_that.year,_that.genre,_that.bitrate,_that.sampleRate);case _:
  return orElse();
